...
#SBATCH --output=/home/sc.uni-leipzig.de/fl53wumy/llaae_new/DistributionalPrincipalAutoencoder/joint_training/tuning7_start21022026_v5_data/out/slurm-%A_%a.out
#SBATCH --error=/home/sc.uni-leipzig.de/fl53wumy/llaae_new/DistributionalPrincipalAutoencoder/joint_training/tuning7_start21022026_v5_data/err/slurm-%A_%a.err
...
STATUS_DIR=/home/sc.uni-leipzig.de/fl53wumy/llaae_new/DistributionalPrincipalAutoencoder/joint_training/tuning7_start21022026_v5_data/status
mkdir -p "$STATUS_DIR"
...
~/.conda/envs/dpa/bin/python ../train_joint_dpa_automated.py \
    --settings_file dpa_tune7_settings.json \
    --epochs 100 \
    --encoder "$enc" \
    --in_dim 648 \
    --latent_dim "$ld" \
