...
def main():
    ...
    torch.save(t_arr_raw, "/work/fl53wumy-llaae_data_new/fl53wumy-llaae_data_new-1748049607/dpa_output/dpa_model3_tuning1/eth_predictions/counterfactual_predictions/dpa_ens_97_arr_raw.pt")
    print("raw array saved")
    torch.save(t_arr_restored, "/work/fl53wumy-llaae_data_new/fl53wumy-llaae_data_new-1748049607/dpa_output/dpa_model3_tuning1/eth_predictions/counterfactual_predictions/dpa_ens_97_arr_restored.pt")
