...
def main():
    ...
    dpa_t_samples_raw, dpa_t_samples, t_arr_raw, t_arr_restored = ut.load_dpa_predicts(predicts_path, mask_x_entire, save_array=True)

    print("Now saving arrays ...")
    torch.save(t_arr_raw, "/work/fl53wumy-llaae_data_new/fl53wumy-llaae_data_new-1748049607/dpa_output/dpa_model3_tuning1/dpa_ens_97_arr_raw.pt")
    print("raw array saved")
    torch.save(t_arr_restored, "/work/fl53wumy-llaae_data_new/fl53wumy-llaae_data_new-1748049607/dpa_output/dpa_model3_tuning1/dpa_ens_97_arr_restored.pt")
