...
#SBATCH --output=/work/fl53wumy-dpa_data/fl53wumy-llaae_data_new_22092025-1763346001/fl53wumy-llaae_data_new-1758244802/fl53wumy-llaae_data_new-1748049607/dpa_output/dpa_tuning3_starting11122025_v4_data/out/slurm-%A_%a.out
#SBATCH --error=/work/fl53wumy-dpa_data/fl53wumy-llaae_data_new_22092025-1763346001/fl53wumy-llaae_data_new-1758244802/fl53wumy-llaae_data_new-1748049607/dpa_output/dpa_tuning3_starting11122025_v4_data/err/slurm-%A_%a.err
...
STATUS_DIR=/work/fl53wumy-dpa_data/fl53wumy-llaae_data_new_22092025-1763346001/fl53wumy-llaae_data_new-1758244802/fl53wumy-llaae_data_new-1748049607/dpa_output/dpa_tuning3_starting11122025_v4_data/status
mkdir -p "$STATUS_DIR"
...
~/.conda/envs/dpa/bin/python ../train_joint_dpa_automated.py \
    --settings_file dpa_tune3_settings.json \
    --epochs 100 \
    --encoder "$enc" \
    --in_dim 648 \
    --latent_dim "$ld" \
