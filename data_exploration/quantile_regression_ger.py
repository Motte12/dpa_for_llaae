...
ds_results.to_netcdf(os.path.join(output_dir, "quantile_regression_predictions_all_data.nc"))
ds_models.to_netcdf(os.path.join(output_dir, "quantile_regression_models_all_data.nc"))
