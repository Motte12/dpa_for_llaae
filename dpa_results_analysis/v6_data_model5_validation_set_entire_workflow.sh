...
# save paths
results_save_comment_val="model5_validation_set_reference_period_1950-1980_${data_version}"
ensemble_save_path_val="/work/fl53wumy-dpa_data/fl53wumy-llaae_data_new_22092025-1763346001/fl53wumy-llaae_data_new-1758244802/fl53wumy-llaae_data_new-1748049607/dpa_output/v6_data_model5/${MODEL}/${results_save_comment_val}/dpa_ensemble_after_${NO_EPOCHS}_epochs/"

results_save_comment_eth="model5_eth_test_set_reference_period_1950-1980_${data_version}"
ensemble_save_path_eth="/work/fl53wumy-dpa_data/fl53wumy-llaae_data_new_22092025-1763346001/fl53wumy-llaae_data_new-1758244802/fl53wumy-llaae_data_new-1748049607/dpa_output/v6_data_model5/${MODEL}/${results_save_comment_eth}/dpa_ensemble_after_${NO_EPOCHS}_epochs/"
