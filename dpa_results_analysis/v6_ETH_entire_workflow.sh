...
MODEL="_50_6_50_5_1001_20_2_50_encoderislearnable_lambda0.5_alpha1.0_bs128_bnisTrue"
...
# save paths
results_save_comment="naive_test_set_standardization_eth_refperiod_1950-1980_${data_version}"
ensemble_save_path="${MODEL_PATH}${MODEL}/${results_save_comment}/dpa_ensemble_after_${NO_EPOCHS}_epochs/"

# Validation set ensemble
#srun python3 create_dpa_ensemble_with_LE_validation_set.py \
...
for i in "${!period_start_years[@]}"; do
    ...
    srun -N1 -n1 python3 analysis_results_sheet_ETH_master_slim.py \
        --period_start $start \
        --period_end $end \
