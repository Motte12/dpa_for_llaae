...
MODEL="autoencode_only_50_6_50_5_1001_20_2_50_encoderislearnable_lambda0.5_bs128_bnisFalse"
...
results_save_comment="actual_STONET_${data_version}_training_data"
...
for i in "${!period_start_years[@]}"; do
    ...
    ~/.conda/envs/dpa/bin/python analysis_results_sheet_ETH_master_slim.py \
        ...
        --StoNet_ensemble 1 \
        --save_path_eth "ETH_analysis_results/final_analysis_test_ETH/StoNet/trained_for_${NO_EPOCHS}_epochs_${results_save_comment}" \
        --save_path_le "ETH_analysis_results/final_analysis_train_LE/StoNet/model_trained_for_${NO_EPOCHS}_epochs_${results_save_comment}" \
        --settings_file_path "/home/sc.uni-leipzig.de/fl53wumy/llaae_new/DistributionalPrincipalAutoencoder/joint_training/${data_version}_dpa_train_settings.json" &
